...
※ 配色に迷ったら→ <nuxt-link to="/web-basic_color#カラーパレット生成ツール">Web基礎知識 - 色について - カラーパレット生成ツール</nuxt-link>
...
保存とコレクション追加までできたら、**TeamsのスレッドにスケッチのURLとひとこと「〇〇を描きました！」を添えて投稿してください！**
